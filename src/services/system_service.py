...
class SystemService:
    ...
    def lock_screen(self):
        ...
        try:
            ...
            return {"status": "error", "message": f"锁屏操作失败: {str(e)}"}
    ...
    def _windows_lock_screen(self):
        ...
        try:
            ...
            if result:
                return {"status": "success", "message": "Windows系统锁屏成功"}
            else:
                return {"status": "error", "message": "Windows系统锁屏失败"}
        except Exception as e:
            return {"status": "error", "message": f"Windows锁屏操作异常: {str(e)}"}
    ...
    def _linux_lock_screen(self):
        ...
        return {"status": "error", "message": "Linux系统锁屏失败，所有锁屏命令都不可用"}
